var EmployeeView = function (employee) {
    ...
    contact.name = {
    	givenName: app.currentEmployee.firstName, 
    	familyName:  app.currentEmployee.lastName
    };
	  var phoneNumbers = [];
    ...
    contact.save(
    	function() {app.showAlert('save success')},
    	function(error) {app.showAlert('save failed: '+error.code)}
    );
    return false;
	};
